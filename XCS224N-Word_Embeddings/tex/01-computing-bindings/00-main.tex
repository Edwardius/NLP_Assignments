...
\begin{enumerate}[(a)]
    ...
    \item \points{1b} Implement the \texttt{compute\_co\_occurrence} function in \texttt{src-co\_occurence/submission.py}. If you aren't familiar with the python \texttt{numpy} package, we suggest walking yourself through this tutorial: \url{http://cs231n.github.io/python-numpy-tutorial}. 
